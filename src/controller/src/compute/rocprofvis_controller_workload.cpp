...
rocprofvis_result_t Workload::GetString(rocprofvis_property_t property, uint64_t index, char* value, uint32_t* length)
{
    ...
    if(length)
    {
        switch(property)
        {
            ...
            case kRPVControllerWorkloadAvailableMetricValueNamesIndexed:
            {
                if(index < m_available_metrics.size())
                {
                    char const* str = StringTable::Get().GetString(m_available_metrics[index].value_names_idx);
                    result = GetStringImpl(value, length, str, static_cast<uint32_t>(strlen(str)));
                }
                else
                {
...
rocprofvis_result_t Workload::SetString(rocprofvis_property_t property, uint64_t index, char const* value)
{
    ...
    switch(property)
    {
        ...
        case kRPVControllerWorkloadAvailableMetricValueNamesIndexed:
        {
            if(index < m_available_metrics.size())
            {
                m_available_metrics[index].value_names_idx = StringTable::Get().AddString(value, true);
                result = kRocProfVisResultSuccess;
            }
            else
            {
...
bool Workload::QueryToPropertyEnum(rocprofvis_db_compute_column_enum_t in, rocprofvis_property_t& property, rocprofvis_controller_primitive_type_t& type) const
{
    ...
    switch(in)
    {
        ...
        {
            property = kRPVControllerWorkloadId;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        case kRPVComputeColumnWorkloadName:
        {
            property = kRPVControllerWorkloadName;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnTableId:
        {
            property = kRPVControllerWorkloadAvailableMetricCategoryIdIndexed;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        ...
        case kRPVComputeColumnMetricTableName:
        {
            property = kRPVControllerWorkloadAvailableMetricCategoryNameIndexed;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnMetricSubTableName:
        {
            property = kRPVControllerWorkloadAvailableMetricTableNameIndexed;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnMetricName:
        {
            property = kRPVControllerWorkloadAvailableMetricNameIndexed;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnMetricDescription:
        {
            property = kRPVControllerWorkloadAvailableMetricDescriptionIndexed;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnMetricUnit:
        {
            property = kRPVControllerWorkloadAvailableMetricUnitIndexed;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnMetricValueNames:
        {
            property = kRPVControllerWorkloadAvailableMetricValueNamesIndexed;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        default:
