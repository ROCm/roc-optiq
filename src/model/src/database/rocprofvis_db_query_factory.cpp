...
std::string
QueryFactory::GetRocprofEssentialInfoQueryForRegionEvent(uint64_t event_id,
                                                         bool     is_sample_track)
{
    if(IsVersionGreaterOrEqual("4"))
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
            { { Builder::QParamOperation(kRocProfVisDmOperationLaunch),
                ...
                Builder::QParam("L.level"), Builder::QParam("L.level_for_stream") },
              { Builder::From("rocpd_region", "R"),
                Builder::InnerJoin("rocpd_track", "T", "T.id = R.track_id"),
                Builder::LeftJoin(
                    Builder::LevelTable(is_sample_track ? "launch_sample" : "launch"),
    ...
    else
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
            { { Builder::QParamOperation(kRocProfVisDmOperationLaunch),
                ...
                Builder::QParam("R.tid", Builder::THREAD_ID_SERVICE_NAME),
                Builder::QParam("-1", Builder::STREAM_ID_SERVICE_NAME),
                Builder::QParam("R.pid", Builder::PID_SERVICE_NAME),
                Builder::QParam("L.level"), Builder::QParam("L.level_for_stream") },
              { Builder::From("rocpd_region", "R"),
                Builder::LeftJoin(
                    Builder::LevelTable(is_sample_track ? "launch_sample" : "launch"),
...
std::string
QueryFactory::GetRocprofEssentialInfoQueryForKernelDispatchEvent(uint64_t event_id)
{
    if(IsVersionGreaterOrEqual("4"))
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
    ...
    else
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
            { { Builder::QParamOperation(kRocProfVisDmOperationDispatch),
                ...
                Builder::QParam("K.queue_id", Builder::QUEUE_ID_SERVICE_NAME),
                Builder::QParam("K.stream_id", Builder::STREAM_ID_SERVICE_NAME),
                Builder::QParam("K.pid", Builder::PID_SERVICE_NAME),
                Builder::QParam("L.level"), Builder::QParam("L.level_for_stream") },
              { Builder::From("rocpd_kernel_dispatch", "K"),
                Builder::LeftJoin(Builder::LevelTable("dispatch"), "L", "K.id = L.eid") },
              { Builder::Where("K.id", "==", std::to_string(event_id)) } }));
...
std::string
QueryFactory::GetRocprofEssentialInfoQueryForMemoryAllocEvent(uint64_t event_id)
{
    if(IsVersionGreaterOrEqual("4"))
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
    ...
    else
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
            { { Builder::QParamOperation(kRocProfVisDmOperationMemoryAllocate),
                ...
                Builder::QParam("M.queue_id", Builder::QUEUE_ID_SERVICE_NAME),
                Builder::QParam("M.stream_id", Builder::STREAM_ID_SERVICE_NAME),
                Builder::QParam("M.pid", Builder::PID_SERVICE_NAME),
                Builder::QParam("L.level"), Builder::QParam("L.level_for_stream") },
              { Builder::From("roc_optiq_memory_allocate", "M"),
                Builder::LeftJoin(Builder::LevelTable("mem_alloc"), "L",
                                  "M.id = L.eid") },
...
std::string
QueryFactory::GetRocprofEssentialInfoQueryForMemoryCopyEvent(uint64_t event_id)
{
    if(IsVersionGreaterOrEqual("4"))
    {
        return Builder::Select(rocprofvis_db_sqlite_essential_data_query_format(
...
std::string
QueryFactory::GetRocprofArgumentsInfoQueryForRegionEvent(uint64_t event_id)
{
...
std::string
QueryFactory::GetRocprofArgumentsInfoQueryForKernelDispatchEvent(uint64_t event_id)
{
    return Builder::Select(rocprofvis_db_sqlite_argument_data_query_format(
        { { Builder::QParamOperation(kRocProfVisDmOperationLaunch),
            Builder::QParam("A.position", Builder::ARG_POS_PUBLIC_NAME),
...
std::string
QueryFactory::GetRocprofArgumentsInfoQueryForMemoryAllocEvent(uint64_t event_id)
{
    return Builder::Select(rocprofvis_db_sqlite_argument_data_query_format(
        { { Builder::QParamOperation(kRocProfVisDmOperationLaunch),
            Builder::QParam("A.position", Builder::ARG_POS_PUBLIC_NAME),
...
std::string
QueryFactory::GetRocprofArgumentsInfoQueryForMemoryCopyEvent(uint64_t event_id)
{
    return Builder::Select(rocprofvis_db_sqlite_argument_data_query_format(
        { { Builder::QParamOperation(kRocProfVisDmOperationLaunch),
            Builder::QParam("A.position", Builder::ARG_POS_PUBLIC_NAME),
