...
{
typedef Reference<rocprofvis_controller_t, Trace, kRPVControllerObjectTypeController>
    TraceRef;
...
typedef Reference<rocprofvis_controller_sample_t, Sample, kRPVControllerObjectTypeSample>
    SampleRef;
typedef Reference<rocprofvis_controller_array_t, Array, kRPVControllerObjectTypeArray>
    ArrayRef;
...
typedef Reference<rocprofvis_controller_graph_t, Graph, kRPVControllerObjectTypeGraph>
    GraphRef;
typedef Reference<rocprofvis_controller_table_t, Table, kRPVControllerObjectTypeTable>
    TableRef;
typedef Reference<rocprofvis_controller_arguments_t, Arguments,
                  kRPVControllerObjectTypeArguments>
    ArgumentsRef;
}  // namespace Controller
}  // namespace RocProfVis
...
extern "C"
{
    rocprofvis_result_t rocprofvis_controller_get_uint64(rocprofvis_handle_t*  object,
                                                         ...
                                                         uint64_t index, uint64_t* value)
    {
        ...
        if(object && value)
        {
            RocProfVis::Controller::Handle* handle =
                (RocProfVis::Controller::Handle*) object;
            result = handle->GetUInt64(property, index, value);
        }
        return result;
    }
    rocprofvis_result_t rocprofvis_controller_get_double(rocprofvis_handle_t*  object,
                                                         rocprofvis_property_t property,
    ...
    rocprofvis_result_t rocprofvis_controller_get_object(rocprofvis_handle_t*  object,
                                                         rocprofvis_property_t property,
                                                         uint64_t              index,
    ...
    rocprofvis_result_t rocprofvis_controller_set_uint64(rocprofvis_handle_t*  object,
                                                         rocprofvis_property_t property,
                                                         uint64_t index, uint64_t value)
    {
        rocprofvis_result_t result = kRocProfVisResultInvalidArgument;
    ...
    rocprofvis_result_t rocprofvis_controller_set_double(rocprofvis_handle_t*  object,
                                                         rocprofvis_property_t property,
                                                         uint64_t index, double value)
    {
        rocprofvis_result_t result = kRocProfVisResultInvalidArgument;
    ...
    rocprofvis_result_t rocprofvis_controller_set_object(rocprofvis_handle_t*  object,
                                                         rocprofvis_property_t property,
                                                         uint64_t              index,
                                                         rocprofvis_handle_t*  value)
    {
    ...
    rocprofvis_result_t rocprofvis_controller_get_string(rocprofvis_handle_t*  object,
                                                         rocprofvis_property_t property,
                                                         uint64_t index, char* value,
                                                         uint32_t* length)
    {
        rocprofvis_result_t result = kRocProfVisResultInvalidArgument;
        if(object && length)
    ...
    rocprofvis_result_t rocprofvis_controller_load_async(
        rocprofvis_controller_t* controller, char const* const filename,
    ...
    {
        rocprofvis_controller_future_t* future =
            (rocprofvis_controller_future_t*) new RocProfVis::Controller::Future();
        return future;
    }
    rocprofvis_controller_array_t* rocprofvis_controller_array_alloc(
        uint32_t initial_size)
    {
        ...
        if(initial_size)
        {
            rocprofvis_result_t result =
                array->SetUInt64(kRPVControllerArrayNumEntries, 0, initial_size);
    ...
    rocprofvis_controller_arguments_t* rocprofvis_controller_arguments_alloc(void)
    {
        rocprofvis_controller_arguments_t* args =
            (rocprofvis_controller_arguments_t*) new RocProfVis::Controller::Arguments();
        return args;
    }
    rocprofvis_result_t rocprofvis_controller_future_wait(
        rocprofvis_controller_future_t* object, float timeout)
    {
        ...
        rocprofvis_controller_future_t* result, rocprofvis_controller_array_t* output)
    {
        ...
        {
            error = trace->AsyncFetch(*graph_ref, *future, *array, start_time, end_time,
                                      x_resolution);
        }
        return error;
    }
        ...
        rocprofvis_controller_array_t* output)
    {
        ...
        RocProfVis::Controller::FutureRef    future(result);
        RocProfVis::Controller::ArrayRef     array(output);
        if(trace.IsValid() && table_ref.IsValid() && args_ref.IsValid() &&
           future.IsValid() && array.IsValid())
        {
