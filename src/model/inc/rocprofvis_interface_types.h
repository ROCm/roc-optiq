...
typedef enum rocprofvis_db_compute_column_enum_t
{
    ...
    kRPVComputeColumnPcSamplingSourceFileUuid,
    kRPVComputeColumnPcSamplingSourceFileWorkloadId,
    kRPVComputeColumnPcSamplingSourceFilePath,
    kRPVComputeColumnPcSamplingSourceFileMd5Checksum,
    kRPVComputeColumnPcSamplingSourceLineUuid,
    kRPVComputeColumnPcSamplingSourceLineSourceFileUuid,
    ...
    kRPVComputeColumnPcSampleStateActiveThreadPercent,
    kRPVComputeColumnPcSampleStateWaveOccupancyPercent,
    kRPVComputeColumnPcSampleStateDispatchUuid,
    kRPVComputeColumnPcSampleStallReasonUuid,
    kRPVComputeColumnPcSampleStallReasonStateUuid,
    kRPVComputeColumnPcSampleStallReasonLookupUuid,
    kRPVComputeColumnPcSampleStallReasonCount,
    kRPVComputeColumnPcSampleStallReasonLookupRecordUuid,
    kRPVComputeColumnPcSampleStallReasonLookupText,
    kRPVComputeColumnPcSamplingKernelSymbolUuid,
    kRPVComputeColumnPcSamplingKernelSymbolCodeObjectUuid,
    kRPVComputeColumnPcSamplingKernelSymbolKernelUuid,
    kRPVComputeColumnPcSamplingKernelSymbolCodeObjectOffset,
    kRPVComputeColumnPcSamplingInstructionLineUuid,
    kRPVComputeColumnPcSamplingInstructionLineKernelSymbolUuid,
    kRPVComputeColumnPcSamplingInstructionLineInstructionTypeUuid,
    kRPVComputeColumnPcSamplingInstructionLineCodeObjectOffset,
    kRPVComputeColumnPcSamplingInstructionLineInstruction,
    kRPVComputeColumnPcSamplingInstructionSourceLineUuid,
    kRPVComputeColumnPcSamplingInstructionSourceLineInstructionUuid,
    kRPVComputeColumnPcSamplingInstructionSourceLineSourceLineUuid,
    kRPVComputeColumnPcSamplingInstructionSourceLineFrameIndex,
    kRPVComputeColumnPcSamplingInstructionTypeLookupUuid,
    kRPVComputeColumnPcSamplingInstructionTypeLookupText,
    kRPVComputeColumnPcSamplingInstructionSampleUuid,
    kRPVComputeColumnPcSamplingInstructionSampleStateUuid,
    kRPVComputeColumnPcSamplingInstructionSampleLookupUuid,
...
typedef enum rocprofvis_db_compute_use_case_enum_t
{
    ...
    kRPVComputeFetchKernelInstructionLines,
    kRPVComputeFetchKernelInstructionSourceLines,
    kRPVComputeFetchKernelPcSampleStates,
    kRPVComputeFetchKernelPcSampleStallReasons,
    kRPVComputeFetchKernelPcSampleStallReasonLookups,
    kRPVComputeFetchKernelSymbols,
