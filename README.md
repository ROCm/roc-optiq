...
1. System Topology Tree
    ...
    - The leaf nodes contain additional options for the related track.
    - Click the `Go To Track` button to navigate to this track in the Timeline View.
...
3. Advanced Details Area
    ...
    - The *Event Details* and *Sample Details* provide a list (table) of the events or samples contained the selected track or tracks. 
    ...
    - The *Event Details* view show detailed information about currently selected event in the timeline view. Currently flow arrow information will only be updated if this tab is active.
