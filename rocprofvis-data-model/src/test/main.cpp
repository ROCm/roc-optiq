                                            ...
                                            if (nullptr != slice)
                                            {
                                                ...
                                                for (int j = first_record; (j < num_records) && (j < first_record+ LIST_SIZE_LIMIT); j++)
                                                {
                                                    ...
                                                    if (track_category == rocprofvis_dm_track_category_t::kRocProfVisDmRegionTrack || track_category == rocprofvis_dm_track_category_t::kRocProfVisDmKernelTrack)
                                                    {
                                                        ...
                                                        PrintHeader("Testing multithreaded access to database retrieving flow, stack and extended data for event id = %lld", event_id.bitfield.event_id);
                                                        ...
                                                        if (kRocProfVisDmResultSuccess == result4flowtrace && kRocProfVisDmResultSuccess == rocprofvis_db_future_wait(object2wait4flowtrace, 1))
                                                        {
                                                            ...
                                                            if (flowtrace != nullptr) {
                                                                PrintHeader("Data flow trace for event id = %lld", event_id.bitfield.event_id);
                                                        ...
                                                        if (kRocProfVisDmResultSuccess == result4stacktrace && kRocProfVisDmResultSuccess == rocprofvis_db_future_wait(object2wait4stacktrace, 1))
                                                        {
                                                            ...
                                                            if (stacktrace != nullptr) {
                                                                PrintHeader("Stack trace for event id = %lld", event_id.bitfield.event_id);
                                                        ...
                                                        if (kRocProfVisDmResultSuccess == result4extdata && kRocProfVisDmResultSuccess == rocprofvis_db_future_wait(object2wait4extdata, 1))
                                                        {
                                                            rocprofvis_dm_extdata_t extdata = rocprofvis_dm_get_property_as_handle(trace, kRPVDMExtInfoHandleByEventID, event_id.value);
                                                            if (extdata != nullptr) {
                                                                PrintHeader("Extended data for event id = %lld", event_id.bitfield.event_id);
