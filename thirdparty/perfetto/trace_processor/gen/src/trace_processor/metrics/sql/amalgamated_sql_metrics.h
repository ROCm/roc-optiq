...
R"_d3l1m1t3r_(    SELECT int_value FROM metadata
...
const char kAndroidAndroidAnomaly[] = R"_d3l1m1t3r_(--
...
R"_d3l1m1t3r_(        RANGE BETWEEN cast_int!(1e9) PRECEDING AND CURRENT ROW
      ) AS count_per_second
...
R"_d3l1m1t3r_(SELECT AndroidBlockingCallsCujMetric('cuj', (
    SELECT RepeatedField(
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW dma_heap_stats AS
SELECT
...
R"_d3l1m1t3r_(      'type_name', type_name,
...
R"_d3l1m1t3r_(SELECT RUN_METRIC('android/power_profile_data/crosshatch.sql');
...
R"_d3l1m1t3r_(SELECT NULL_IF_EMPTY(AndroidProcessMetadata(
    'name', process_name,
    'uid', uid,
    'pid', pid,
...
R"_d3l1m1t3r_(            'unit', 'TRUE_OR_FALSE') as expected_val,
...
R"_d3l1m1t3r_(          AndroidStartupMetric_ThresholdValue(
            'value', FALSE,
            'unit', 'TRUE_OR_FALSE') as expected_val,
          AndroidStartupMetric_ActualValue(
            'value', TRUE) as actual_val,
...
R"_d3l1m1t3r_(          AND total_gc_time_by_launch(launch.startup_id) > 0
...
R"_d3l1m1t3r_(            'value', main_thread_time_for_launch_and_state(launch.startup_id, 'S')) as actual_val,
          NULL as trace_slices,
...
R"_d3l1m1t3r_(          get_main_thread_time_for_launch_state_and_io_wait(
...
R"_d3l1m1t3r_(              launch.startup_id, 'OpenDexFilesFromOat*')) as actual_val,
...
R"_d3l1m1t3r_(          get_dur_on_main_thread_for_startup_and_slice(launch.startup_id, 'bindApplication', 3)
            as trace_slices,
          NULL as trace_threads,
          NULL as extra
        FROM android_startups launch
...
R"_d3l1m1t3r_(          NULL as trace_threads,
          NULL as extra
        FROM android_startups launch
        WHERE launch.startup_id = $startup_id
...
R"_d3l1m1t3r_(          main_thread_time_for_launch_in_runnable_state(launch.startup_id) > 100e6 AND
...
R"_d3l1m1t3r_(          launch.startup_id,
          'Running',
          'Jit thread pool'
        ) > 100e6
...
R"_d3l1m1t3r_(          NULL as traced_threads,
          NULL as extra
        FROM android_startups launch
        WHERE launch.startup_id = $startup_id
          AND (
...
R"_d3l1m1t3r_(          AND count_slices_concurrent_to_launch(
            launch.startup_id,
...
R"_d3l1m1t3r_(          WHERE l.startup_id != launch.startup_id
            AND _is_spans_overlapping(l.ts, l.ts_end, launch.ts, launch.ts_end))
...
const char kAndroidWattsonAppStartup[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(SELECT AndroidWattsonTimePeriodMetric(
  'metric_version', 1,
...
const char kAndroidWattsonEstimate[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(  'window_table', '_wattson_period_windows'
);
...
const char kAndroidWattsonRailRelations[] = R"_d3l1m1t3r_(
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(CROSS JOIN _dev_cpu_policy_map as map WHERE map.cpu = 3
GROUP BY period_id
UNION ALL
SELECT
  period_id,
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW _wattson_cpu_subrail_grouped AS
SELECT
  period_id,
  NULL as policy,
  'DSU_SCU' as name,
...
R"_d3l1m1t3r_(  OR args.string_value = "GESTURE_SCROLL_END")
...
R"_d3l1m1t3r_(-- calculating intervals per process as multiple chrome instances can be up
-- on system traces.
...
const FileToSql kFileToSql[] = {
  ...
  {"android/android_anomaly.sql", kAndroidAndroidAnomaly},
  ...
  {"android/wattson_app_startup.sql", kAndroidWattsonAppStartup},

  {"android/wattson_estimate.sql", kAndroidWattsonEstimate},

  {"android/wattson_rail_relations.sql", kAndroidWattsonRailRelations},
