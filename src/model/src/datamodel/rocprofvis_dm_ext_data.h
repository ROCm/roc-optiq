...
class ExtData : public DmBase {
    public:
        inline static std::string ArgsCategory = "ARGS";
    ...
    private:
        ...
        std::vector<ArgumentRecord> m_argument_records;
        ...
        rocprofvis_dm_result_t GetArgumentPositionAt(const rocprofvis_dm_property_index_t index, uint64_t& position);
        rocprofvis_dm_result_t GetArgumentTypeAt(const rocprofvis_dm_property_index_t index, rocprofvis_dm_charptr_t& type);
        rocprofvis_dm_result_t GetArgumentNameAt(const rocprofvis_dm_property_index_t index, rocprofvis_dm_charptr_t& name);
        rocprofvis_dm_result_t GetArgumentValueAt(const rocprofvis_dm_property_index_t index, rocprofvis_dm_charptr_t& value);
