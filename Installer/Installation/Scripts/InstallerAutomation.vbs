...
Function AddComponents(fileName, updatedFileName, filePath, folderName, componentFolderName)
	...
	'If InStr(updatedComponentCondition, "VersionNT64") > 0 Then
		'objComponent.64BitComponent = True
	'End If
	If (StrComp(UCase(updatedComponentCondition),"VERSIONNT64") = 0) then
		objComponent.Attrib64BitComponent = True	
	End If
