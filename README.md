> [!IMPORTANT]
> **Profiler Hub loader migration:** This branch migrates the data loader onto the Profiler Hub reader API. See [docs/README-profiler-hub-migration.md](docs/README-profiler-hub-migration.md) for the migration summary.
