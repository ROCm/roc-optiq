                                          ...
                                          rocprofvis_controller_sort_order_t sort_order)
{
    return FetchSingleTrackTable(
        TableRequestParams(kRPVControllerTableTypeSamples, { track_id }, start_ts, end_ts, filter, group,
...
{
    return FetchSingleTrackTable(
        TableRequestParams(kRPVControllerTableTypeEvents, { track_id }, start_ts, end_ts, filter, group,
                           start_row, req_row_count, sort_column_index, sort_order));
}
                                         ...
                                         rocprofvis_controller_sort_order_t sort_order)
{
    return FetchMultiTrackTable(TableRequestParams(
        kRPVControllerTableTypeSamples, track_ids, start_ts, end_ts, filter, group, start_row, req_row_count, sort_column_index, sort_order));
}
