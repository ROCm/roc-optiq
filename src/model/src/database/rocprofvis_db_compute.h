...
namespace DataModel
{
    ...
    public:
        ...
        rocprofvis_dm_result_t GetComputeKernelSamplingStallReasonTypes(rocprofvis_db_num_of_params_t num, rocprofvis_db_compute_params_t params, rocprofvis_dm_string_t& query_out);
    private:
