                          ...
                          std::function<void(std::string)> callback)
{
    ...
    nfdresult_t result =
        NFD_SaveDialog(file_filter.c_str(),
                       initial_path.empty() ? nullptr : initial_path.c_str(), &outPath);
...
{
    nfdchar_t*  outPath = nullptr;
    nfdresult_t result  = NFD_OpenDialog(file_filter.c_str(), nullptr, &outPath);
