...
{
public:
    FlowControl(uint64_t id, uint64_t timestamp, uint64_t end_timestamp, uint32_t track_id, uint32_t level, uint32_t direction, const char* category, const char* symbol);
