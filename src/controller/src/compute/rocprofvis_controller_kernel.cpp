...
bool Kernel::QueryToPropertyEnum(rocprofvis_db_compute_column_enum_t in, rocprofvis_property_t& property, rocprofvis_controller_primitive_type_t& type) const
{
    bool valid = true;
    switch(in)
    {
        ...
        {
            property = kRPVControllerKernelId;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        case kRPVComputeColumnKernelName:
        {
            property = kRPVControllerKernelName;
            type = kRPVControllerPrimitiveTypeString;
            break;
        }
        case kRPVComputeColumnKernelsCount:
        {
            property = kRPVControllerKernelInvocationCount;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        case kRPVComputeColumnKernelDurationsSum:
        {
            property = kRPVControllerKernelDurationTotal;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        case kRPVComputeColumnKernelDurationsAvg:
        {
            property = kRPVControllerKernelDurationMean;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        case kRPVComputeColumnKernelDurationsMedian:
        {
            property = kRPVControllerKernelDurationMedian;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
        case kRPVComputeColumnKernelDurationsMin:
        {
            property = kRPVControllerKernelDurationMin;
            type = kRPVControllerPrimitiveTypeUInt64;
            break;
        }
