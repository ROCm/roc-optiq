...
public:
    ...
    const std::vector<std::shared_ptr<MetricValue>>*  GetKernelMetricsData(uint64_t store_id, uint32_t kernel_id) const;
    ...
    std::shared_ptr<MetricValue> GetWorkloadMetricValue(uint64_t store_id, uint32_t workload_id, uint32_t category_id, uint32_t table_id, uint32_t entry_id) const;     
    std::shared_ptr<MetricValue> GetWorkloadMetricValue(uint64_t store_id, uint32_t workload_id, uint64_t metric_key) const;

    // Kernel metric accessors
    std::shared_ptr<MetricValue> GetKernelMetricValue(uint64_t store_id, uint32_t kernel_id, uint32_t category_id, uint32_t table_id, uint32_t entry_id) const;     
    std::shared_ptr<MetricValue> GetKernelMetricValue(uint64_t store_id, uint32_t kernel_id, uint64_t metric_key) const;

    MetricValuesByEntryId* GetKernelMetricValuesByTable(uint64_t store_id, uint32_t kernel_id,
