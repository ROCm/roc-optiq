...
void
Grid::RenderGrid(double min_x, double max_x, double movement, double zoom,
                 ImDrawList* draw_list, double scale_x, double v_max_x, double v_min_x)
{
    ...
    double temp_sidebar_size = 400.0f;  // Replace with resizeable sidebar variable.
       ...
       window_flags)
    {
        ...
        double  boxWidth   = 300.0f;  // Specify the width of the box
