...
1. Download the **ROCm-Optiq-Beta.exe** installer from the `ROCm Optiq GitHub repo <https://github.com/ROCm/roc-optiq/releases/tag/v0.3.0-optiq-beta>`_ and follow the instructions in the install wizard.
...
1. Download the ``.deb`` package from the `ROCm Optiq GitHub repo <https://github.com/ROCm/roc-optiq/releases/tag/v0.3.0-optiq-beta>`_.
...
.. tip::
   ...
   Download the latest ``.deb`` from the `ROCm Optiq GitHub repo <https://github.com/ROCm/roc-optiq/releases/tag/v0.3.0-optiq-beta>`_ to ensure ROCm Optiq is up-to-date.
